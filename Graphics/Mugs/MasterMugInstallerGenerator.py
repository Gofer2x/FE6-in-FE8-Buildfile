...
paletteSwaps = [
    ...
    ["Villager6","Villager17","Villager29","Villager41","Villager53"],
    ["Villager3","Villager26","Villager38","Villager50"],
    ["Villager4","Villager15","Villager27","Villager39","Villager51"],
    ["Villager5","Villager16","Villager28","Villager40","Villager52"],
    ["Villager7","Villager18","Villager30","Villager42","Villager54"],
    ["Villager12","Villager23","Villager35","Villager47","Villager59"],
    ["Villager11","Villager22","Villager34","Villager46","Villager58"],
    ["Villager13","Villager24","Villager36","Villager48","Villager60"],
    ["Villager14","Villager25","Villager37","Villager49","Villager61"],
    ["Villager9","Villager20","Villager32","Villager44","Villager56"],
    ["Villager10","Villager21","Villager33","Villager45","Villager57"],
    ["Villager8","Villager19","Villager31","Villager43","Villager55"],
    ["Legance","Morgan"],
    ["Orlo","Martel","Windham"],
    ["Wagner","Nord"],
    ["Peres","Oates"],
        ...
        if name in swap:
            ...
            if name == swap[0]:
                templateString = [
                    ...
                    ("setMugEntryManual("+name+"Mug, "+name+"MugData, "+name+"MugFramesData, "+name+"MugPaletteData, "+name+"MugMiniData, "+a+","+b+","+c+","+d+")\n")
                ]
            else:
                ogName = swap[0]
                templateString = [
                    ...
                    (name+"MugPaletteData:\n"),
                    ("#incbin \"Dmp/"+name+"_palette.dmp\"\n"),
                    ("setMugEntryManual("+name+"Mug, "+ogName+"MugData, "+ogName+"MugFramesData, "+name+"MugPaletteData, "+ogName+"MugMiniData, "+a+","+b+","+c+","+d+")\n")
                ]
            break
