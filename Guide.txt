...
can move items, classes, and characters around in their tables. then go into "enumerate" and run the table reader, enumerate all bat, then move the new definitions to the definitions ids.
...
GRAPHICS:
	...
	Afterwards, open "Master Mug Installer Generator.py" in a text editor. This is where you'll set up how your mug should be installed.
	...
	When done, run "Master Mug Installer Generator.py". Press enter when it finishes.
